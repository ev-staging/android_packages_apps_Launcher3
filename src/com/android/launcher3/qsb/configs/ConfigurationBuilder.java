...
public class ConfigurationBuilder {
    ...
    public static final String FAST_TEXT_SEARCH = "com.google.nexuslauncher.FAST_TEXT_SEARCH";
    public static final String APP_LAUNCH = "com.google.android.apps.nexuslauncher.search.APP_LAUNCH";
    ...
    public ConfigurationBuilder(AllAppsQsbContainer qsbContainer, boolean isAllApps) {
        ...
        mLauncher = mAllAppsQsbContainer.getLauncher();
    ...
    public static Intent getSearchIntent(Rect sourceBounds, View gIcon, View micIcon) {
        Intent intent = new Intent(FAST_TEXT_SEARCH);
        ...
        return intent.putExtra("source_round_left", true)
                ...
                .setPackage(SearchLauncherCallbacks.SEARCH_PACKAGE).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY | Intent.FLAG_ACTIVITY_NEW_TASK);
    }
    ...
    public final AppIndex mo8435bZ(AppInfo appInfo, int n) {
        ...
        apps.predictionRank = new Intent(APP_LAUNCH,
    ...
    public final RemoteViews searchQsbTemplate() {
        ...
        Bitmap mShadowBitmap = mAllAppsQsbContainer.getShadowBitmap();
        ...
        if (mAllAppsQsbContainer.getSearchIcon().getVisibility() != View.VISIBLE) {
    ...
    public void createSearchTemplate() {
        ...
        mNano.micIcon = mAllAppsQsbContainer.getSearchIcon().getVisibility() == View.VISIBLE ? R.id.mic_icon : 0;
